...
$(document).ready(function(){
	$(".ba-home").click(function(){
//Необходимо прокрутить в начало страницы
var curPos=$(document).scrollTop();
var scrollTime=1300;
$("body,html").animate({"scrollTop":0},scrollTime);
});
	$(".menu").on("click",".ba-nav", function (event) {
...
$(window).scroll(function(){
    $('.ba-header__menu').toggleClass('header-has-background', $(this).scrollTop() > 0);
    $('.top-bar-right').removeClass('ba-toggle', $(this).scrollTop() > 0);
});

$(".menu-icon").click(function () {
     $(".ba-header__menu").toggleClass("header-top-background");
   });
